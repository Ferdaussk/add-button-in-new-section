...
<div id="bdt-elementpack-template-library-header-logo-area">
	<div class="elementor-templates-modal__header__logo">
		<span class="elementor-templates-modal__header__logo__icon-wrapper ep-logo-wrapper ferdaussk01-tem-lib-icon">bwd</span>
		<span class="elementor-templates-modal__header__logo__title">BWD Template Library Ferdaus SK01</span>
	</div>
</div>
