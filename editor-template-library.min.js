...
!(function (e) {
    ...
    var t,
        a,
        n = window.ElementPackLibreryData || {};
    (a = {
        ...
        init: function () {
            var e = this;
            (e.EpTemplateLibraryTemplateModel = Backbone.Model.extend({ defaults: { id: 0, template_id: 0, title: "", thumbnail: "", demo_url: "", is_pro: "", preview: "", source: "", package: "", date: "", categories: "" } })),
                (e.EpCategoryModel = Backbone.Model.extend({ defaults: { term_slug: "", term_name: "", count: 0 } })),
                (e.EpTabModel = Backbone.Model.extend({ defaults: { term_slug: "", term_name: "", count: 0 } })),
                ...
                (e.EpTemplateLoadingView = Marionette.ItemView.extend({ id: "bdt-elementpack-template-library-loading", template: "#view-bdt-elementpack-template-library-loading" })),
                (e.EpTemplateErrorView = Marionette.ItemView.extend({ id: "bdt-elementpack-template-library-error", template: "#view-bdt-elementpack-template-library-error" })),
                (e.EpTemplateHeaderView = Marionette.LayoutView.extend({
                    ...
                    ui: { closeModal: "#bdt-elementpack-template-library-header-close-modal", syncBtn: "#bdt-elementpack-template-library-header-sync.elementor-templates-modal__header__item>i" },
                    events: { "click @ui.closeModal": "onCloseModalClick", "click @ui.syncBtn": "onSyncBtnClick" },
                    regions: { headerTabs: "#bdt-elementpack-template-library-header-tabs", headerActions: "#bdt-elementpack-template-library-header-actions" },
                ...
                (e.EpTemplateInsertTemplateBehavior = Marionette.Behavior.extend({
                    ...
                    onInsertButtonClick: function () {
                        ...
                        t.layout.showLoadingView(),
                            ...
                            elementorCommon.ajax.addRequest("get_bdt_elementpack_template_data", n);
                    },
                })),
                ...
                (e.EpTemplateProButton = Marionette.ItemView.extend({ template: "#view-bdt-elementpack-template-library-pro-button", id: "bdt-elementpack-template-library-pro-button" })),
                (e.EpTemplateTemplateItemView = Marionette.ItemView.extend({
                    template: "#view-bdt-elementpack-template-library-item",
                    className: function () {
                        var e = " bdt-elementpack-template-has-url",
                            t = " elementor-template-library-template-";
                        return (
                            "" === this.model.get("demo_url") && (e = " bdt-elementpacks-template-no-url"),
                            "bdt-elementpack-local" == this.model.get("is_pro") ? (t += "local") : (t += "remote"),
                ...
                (e.EpTemplateBodyView = Marionette.LayoutView.extend({
                    ...
                    regions: { contentTemplates: ".bdt-elementpack-templates-list", contentFilters: ".bdt-elementpack-filters-list" },
                })),
                (e.EpTemplateLayoutView = Marionette.LayoutView.extend({
                    el: "#bdt-elementpack-template-library-modal",
                    regions: n.modalRegions,
                    initialize: function () {
                        this.getRegion("modalHeader").show(new e.EpTemplateHeaderView()), this.listenTo(t.channels.tabs, "filter:change", this.switchTabs), this.listenTo(t.channels.layout, "preview:change", this.switchPreview);
                    },
                    switchTabs: function () {
                    ...
                    switchPreview: function () {
                        var a = this.getHeaderView(),
                            l = t.getPreview();
                        if ("back" === l) return a.headerTabs.show(new e.EpTemplateTabsCollectionView({ collection: t.collections.tabs })), a.headerActions.empty(), void t.setTab(t.getTab());
                        "initial" !== l
                            ? (this.getRegion("modalContent").show(new e.EpTemplatePreviewView({ preview: l.get("demo_url") })),
                              a.headerTabs.show(new e.EpTemplateHeaderBack()),
                              1 != l.get("is_pro") || n.license.activated ? a.headerActions.show(new e.EpTemplateHeaderInsertButton({ model: l })) : a.headerActions.show(new e.EpTemplateProButton({ model: l })))
                    ...
                    showTemplatesView: function (a, n) {
                        ...
                        (t.collections.tabs = new e.EpTemplateTabsCollection(t.getTabs())),
                            i.headerTabs.show(new e.EpTemplateTabsCollectionView({ collection: t.collections.tabs })),
                            l.contentTemplates.show(new e.EpTemplateCollectionView({ collection: a })),
        ...
        (t = {
            ...
            onPreviewLoaded: function () {
                ...
                window.elementor.$previewContents.on("click", ".elementor-editor-element-setting.elementor-editor-element-add", this.initLibraryButton),
                    window.elementor.$previewContents.on("click.addBdtElementPackTemplate", ".elementor-add-ep-button", _.bind(this.showTemplatesModal, this)),
                    (this.channels = { templates: Backbone.Radio.channel("EP_THEME_EDITOR:templates"), tabs: Backbone.Radio.channel("EP_THEME_EDITOR:tabs"), layout: Backbone.Radio.channel("EP_THEME_EDITOR:layout") }),
                    (this.tabs = n.tabs),
            ...
            initLibraryButton: function () {
                var a = window.elementor.$previewContents.find(".elementor-add-new-section"),
                    l = '<div class="elementor-add-section-area-button elementor-add-ep-button"><span class="ferdaussk01-new-sec-icon">bwd</span></div>';
                a.find(".elementor-add-ep-button").length ||
                    (a.length && n.libraryButton && e(l).prependTo(a),
                    window.elementor.$previewContents.on("click.addBdtElementPackTemplate", ".elementor-editor-section-settings .elementor-editor-element-add", function () {
            ...
            showTemplatesModal: function () {
                this.getModal().show(), this.layout || ((this.layout = new a.EpTemplateLayoutView()), this.layout.showLoadingView()), this.setTab(this.defaultTab, !0), this.getTemplatedata(this.defaultTab), this.setPreview("initial");
            },
                ...
                n.setFilter("category", !1),
                    l.data.templates && l.data.categories
                        ...
                        : e.ajax({
                              ...
                              type: "post",
                              dataType: "json",
                              data: { action: "bdt_element_pack_template_library_get_layouts", tab: t },
                              success: function (e) {
                                  var l = new a.EpTemplateCollection(e.data.templates),
                                      i = new a.EpCategoriesCollection(e.data.categories);
            ...
            showSearchCounter: function () {
                t.getFilter("searchkeyword")
                    ? (e("#bdt-elementpack-template-library-content .search-result-counter span").html(this.countResult), e("#bdt-elementpack-template-library-content .search-result-counter").show())
                    : this.hideSearchCounter();
            },
            hideSearchCounter: function () {
                e("#bdt-elementpack-template-library-content .search-result-counter").hide(), e("#bdt-elementpack-template-library-content .search-result-counter span").html(0);
            },
            closeModal: function () {
                this.getModal().hide(), this.showHeaderLogo();
            },
            getModal: function () {
                return this.modal || (this.modal = elementor.dialogsManager.createWidget("lightbox", { id: "bdt-elementpack-template-library-modal", closeButton: !1 })), this.modal;
            },
        }),
